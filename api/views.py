...
cred = credentials.Certificate("firebase/serviceAccountKey.json")  # Path to your service account key JSON file
...
def create_notification(request):
    if request.method == 'POST':
        # Assuming your admin sends notification data in JSON format
        notification_data = request.data

        # Extracting icon, title, and text from the notification data
        ...
        # Sending the notification to all Flutter users using Firebase Cloud Messaging
        try:
